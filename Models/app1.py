...
# Load the model
model_path = os.path.abspath("E:/neuorologist_whole/project1/model/model1/model/deep_seg_model.keras")
...
def predict():
    try:
        ...
        ground_truth_path = os.path.join("C:/Users/Narendra vardhan/Desktop/Brain_Tumor_2k/brain-tumor-segmentation/masks", os.path.splitext(os.path.basename(filepath))[0] + ".png")
